                    ...
                    <div class="slide_wrap">
                      <div class="owl-carousel owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                          <div class="owl-stage" style="width: 4378px; transform: translate3d(0px, 0px, 0px); transition: all 0.25s ease 0s;">
                            <!-- 포스트 리스트 -->
                            <div class="owl-item actie" style="width: 184px;margin-right: 15px;">
                              <div class="item">
                                <!-- 포스트 정보 -->
                                <div class="top_info">
                                  <div class="post_info">
