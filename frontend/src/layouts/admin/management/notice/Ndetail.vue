<template>
      <v-col cols="12" class="pa-0 mb-5 nd_dt_submit_box">
    <v-btn
     @click="$router.push({name:'nmodify'})"
     class="pa-0 nd_dt_submit">
      <span>수정</span>
    </v-btn>
    <v-btn
     @click="$router.push({name:'/'})"
     class="pa-0 ml-3 nd_dt_submit">
      <span>삭제</span>
    </v-btn>
     <v-btn
